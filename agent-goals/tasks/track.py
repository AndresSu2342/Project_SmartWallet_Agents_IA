...
from ..tools.goals_tools import get_goal_by_id, load_goals_from_input
...
def run(input_json: Dict[str, Any]) -> Dict[str, Any]:
    ...
    monthly_surplus = float((input_json.get("financial_context") or {}).get("monthly_surplus", 0) or 0)
